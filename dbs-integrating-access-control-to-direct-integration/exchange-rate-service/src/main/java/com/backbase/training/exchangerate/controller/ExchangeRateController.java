...
public class ExchangeRateController implements ExchangeApi {
     ...
     */
    @Override
    //TODO 4: Apply the PreAuthorize checkPermission for the Currencies so only Peter will be able to see it. Check community on how to do it: https://community.backbase.com/documentation/entitlements/2-16-0/entitlements_integrate_into_a_capability
     ...
     */
    @Override
    //TODO 5: Apply the PreAuthorize checkPermission for the Rates so only Jonathan will be able to see it. Check community on how to do it: https://community.backbase.com/documentation/entitlements/2-16-0/entitlements_integrate_into_a_capability
