...
public class ExchangeRateService {
    private static final String TRANSFER_WISE_TOKEN_CLAIM_NAME = "twToken";
    ...
    //TODO 3: Extract the TransferWise token from the claim added in the previous TODO (Tip: Use SecurityContextUtil)
    private String retrieveTokenFromClaim() {
        log.info("Retrieving internal JWT claim '{}'", TRANSFER_WISE_TOKEN_CLAIM_NAME);
    ...
    private HttpEntity authorizedHeader() {
        ...
        //TODO 4: Add the extracted token to the authorization header
        //code here
